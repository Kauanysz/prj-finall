...
<body>
    <div class="side-menu">
        ...
        <ul>
            ...
            <li>
                <lord-icon src="https://cdn.lordicon.com/hursldrn.json" trigger="hover" colors="primary:#fff,secondary:#e74c4c" style="width:50px;height:50px"></lord-icon>&nbsp;<span><a href="#">categoria</a></span>
            </li>
            <li>
